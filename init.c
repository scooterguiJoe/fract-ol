...
/*   Updated: 2025/04/25 17:20:10 by guvascon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_hook(fractol->mlx_window, KeyPress, KeyPressMask, ft_keyhandle, fractol);
	mlx_hook(fractol->mlx_window, ButtonPress, ButtonPressMask, ft_mousehandler, fractol);
	mlx_hook(fractol->mlx_window, DestroyNotify, StructureNotifyMask, ft_closehandler, fractol);
}
